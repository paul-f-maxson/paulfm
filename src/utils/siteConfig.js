module.exports = {
  ...
  siteDescription: `Paul Maxson's Portfolio, Resume, and Blog`,
  ...
  piecesPerHomePage: 7, // Number of pieces shown on the 1st page of of the index.js template (home page)
  piecesPerPage: 6, // Number of pieces shown on paginated pages
